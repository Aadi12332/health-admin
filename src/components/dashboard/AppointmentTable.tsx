...
function AppointmentTable() {
  ...
  const filteredData =
    filter === "today" ? data.filter((row) => row[2] === todayDate) : data;

  return (
    <div className="bg-white lg:p-6 p-3 rounded-lg lg:rounded-[14px] border border-[#0000001A] max-h-[420px] overflow-hidden">
